                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @auth
                        ...
                        @elseif(auth()->user()->isEmployee())
                            ...
                            <x-nav-link :href="route('employee.today-work')" :active="request()->routeIs('employee.today-work')">
                                {{ __('Today\'s Work') }}
                            </x-nav-link>
        ...
        <div class="pt-2 pb-3 space-y-1">
            @auth
                ...
                @elseif(auth()->user()->isEmployee())
                    ...
                    <x-responsive-nav-link :href="route('employee.today-work')" :active="request()->routeIs('employee.today-work')">
                        {{ __('Today\'s Work') }}
                    </x-responsive-nav-link>
